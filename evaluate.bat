...
python utils/evaluate_results.py --checkpoint "lightning_logs/version_1/checkpoints/advanced-epoch=112-val_dice=0.656.ckpt" --num_samples 6 --save_dir "evaluation_results"
